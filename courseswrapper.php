...
<head>
	...
	function loader(name){ //ajaxing the info
		...
		function forums(name){ //ajaxing the contents of forums
			if(window.XMLHttpRequest){
				xmlhttp=new XMLHttpRequest();
			}
			else{
	...
	<div class="container-fluid">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse " id="menu_items1">
						<ul id="menu" class="nav navbar-nav" style="float:right;padding-right:4%">
							<li >
								<a href="#" role="button" data-toggle="modal" data-target="#myModal"><!--on click modal-->
									<div class="limiter">
										<?php    //display username if logged in
		...
		<div class="row">
			...
			<div class="col-md-3">
					...
					<?php //to show directory contents on side menu
					$dir='mat';
					$arr=array();
					$i=0;
